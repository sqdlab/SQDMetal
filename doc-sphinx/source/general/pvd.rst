...
.. note::
    See the `worked example <../examples/PVD_simulation.ipynb>`_ for a full demonstration.
...
.. figure:: /_static/PVD_idea.drawio.svg
    :alt: Parameters used in the U-clip
    :align: center
    :scale: 100%

    Geometry of shadow evaporation
...
.. figure:: /_static/PVD_angle.drawio.svg
    :alt: Angles when specifying shadow evaporation profiles.
    :align: center
    :scale: 100%

    Angles when specifying shadow evaporation profiles in ``PVD_Shadows``.
...
.. figure:: /_static/PVD_options.drawio.svg
    :alt: PVD modes when using PVD_Shadows
    :align: center
    :scale: 100%

    Modes when specifying shadow evaporation profiles in ``PVD_Shadows``

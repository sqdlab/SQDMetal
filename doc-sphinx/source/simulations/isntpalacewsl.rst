Installing AWS Palace on Windows via WSL
========================================
...
.. note::
    **You must be on Windows 10 version 2004 or Windows 11**. Check your windows version in settings, then system section, scroll down to  *about*.
...
Now install spack (see `here <https://spack.readthedocs.io/en/latest/installing_prerequisites.html#verify-spack-prerequisites>`__ for reference) by typing:

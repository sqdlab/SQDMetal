...
class MultiDieChip:
    ...
    def make_resonator_chip(export_filename, 
        ...
        # TODO: add top_bottom functionality
        # # over-ride transmission line y position if top_bottom is True
        # if top_bottom:
        #     tl_y = "0um"
        ...
        for i, origin in enumerate(die_coords):
            ...
            # new_layer_ind = gds_export.add_boolean_layer(11, 12, "or")
            if export_path=="":

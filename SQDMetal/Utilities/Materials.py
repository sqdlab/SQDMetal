    ...
    def __init__(self, name="", **kwargs):
        if name == "":
            ...
            # TODO: Look into what the default orientation of sapphire should be considered.
                ...
                name == "sapphire"
                or name == "sapphireperp"
                or name == "sapphireperpendicular"
            ):
...
class MaterialInterface:
    def __init__(self, name="", **kwargs):
        if name == "":
            ...
            if (
                name == "siliconair"
                or name == "siliconvacuum"
                or name == "airsilicon"
                or name == "vacuumsilicon"
                or name == "siliconoxide"
            ):
            ...
            #
                ...
                name == "aluminiumair"
                or name == "aluminiumvacuum"
                or name == "airaluminium"
                or name == "vacuumaluminium"
                or name == "aluminiumoxide"
            ):
            ...
            # [2] https://ieeexplore.ieee.org/document/1717770
                ...
                name == "tantalumair"
                or name == "tantalumvacuum"
                or name == "airtantalum"
                or name == "vacuumtantalum"
                or name == "tantalumoxide"
            ):

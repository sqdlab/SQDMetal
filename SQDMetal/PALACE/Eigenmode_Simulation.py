...
class PALACE_Eigenmode_Simulation(PALACE_Simulation_Base):
    ...
    #constructor
    def __init__(self, name, Gmsh_Renderer, mode, launchpad_list, user_options = default_user_options, 
                 view_design_gmsh_gui = False, createFiles = False):
        self.name = name
    ...
    def prepare_simulation(self):
        ...
        self.Gmsh_Renderer._prepare_design('eigenmode_simulation')
        ...
        #create mesh
        self.Gmsh_Renderer._intelligent_mesh('eigenmode_simulation', min_size = self.user_options['mesh_min'], 
                                             max_size = self.user_options['mesh_max'], mesh_sampling = self.user_options['mesh_sampling'])

...
- [Basic  eigenmode simulation of transmon coupled to a resonator (Gmsh)](Palace_Eigenmode_Transmon_Res.ipynb) - includes Hamiltonian parameter extraction using the EPR method
